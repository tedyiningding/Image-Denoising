...
The code solves the problem using the over-relaxed Chambolle-Pock algorithm [2, Algorithm 3.1] after obtaining a saddle-point problem [1, Example 5.6]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjA4NDM0OTEwLC0xODcxNDMxNTg0LC04MD
